            ...
            <div class="GFG">
                ...
                <div class="col-12">
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-12 text-start text-decoration-underline text-orange ">
                                    <h2 class="fw-bolder">Rajasi Cousins</h2>
                                </div>
                                <div class="col-12 text-start fw-bold">
                                    <span>Madapatha, Piliyandala, Sri Lanka</span><br />
                                    <span>+94112546978</span><br />
                                    <span>rajasi@gmail.com</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 mb-4">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <span class="fw-bold"><?php echo $ar["no"] . " " . $ar["street"]; ?></span><br />
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="height: 70px;">
                                    ...
                                    <td>
                                        <a href="#" class="fs-6 fw-bold p-2"><?php $oid; ?></a>
                                        <br />
                ...
                <div class="col-12 mt-3 mb-3 border border-start border-end-0 border-top-0 border-bottom-0 border-5 border-dark rounded" style="background-color: lightcoral;">
                    <div class="row">
