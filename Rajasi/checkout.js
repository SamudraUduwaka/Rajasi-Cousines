...
//                     "return_url": "http://localhost/rajasi/singleproductview.php?id=" + id, // Important
//                     "cancel_url": "http://localhost/rajasi/singleproductview.php?id=" + id, // Important
...
function pay() {
    Swal.fire({
        icon: 'error',
        title: 'Oops...',
        text: 'This service isnot available right now!',
